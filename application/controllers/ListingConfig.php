...
class ListingConfig extends CI_Controller {
	...
	*/
	...
	private $Module = 'listing'; //Module
	private $Folder = 'listing'; //Set Default Folder For html files and Front End Use
	private $SubFolder = '/config'; //Set Default Sub Folder For html files and Front End Use Start with /
	...
	private $Route = 'listing_configs'; //If you have different route Name to Module name State it here |This wont be pluralized

	private $New = 'listing_configs/new'; //New 
	private $Save = 'listing_configs/save'; //Add New 
	private $Edit = 'listing_configs/update'; //Update 
...
/* End of file ListingConfig.php */
/* Location: ./application/controllers/ListingConfig.php */