...
class _baseController extends CI_Controller {
	...
	*/
	...
	private $Escape = '/* espace column while auto form generated | Comma separated */'; // Escape Column For Form Auto Generating
	private $Require = '/* requred table value while form validation | Comma separated */'; // Required Column During Form Validation
	private $Unique = '/* unique table value while form validation | Comma separated */'; // Unique & Required Values During Form Validation
