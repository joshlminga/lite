...
class ExtensionNewsPosts extends CI_Controller {
	...
	*/
	...
	private $Folder = 'extenions'; //Module
	private $SubFolder = '/news_posts'; //Set Default Sub Folder For html files and Front End Use Start with /
	...
	private $Route = 'newsposts';//If you have different route Name to Module name State it here |This wont be pluralized | set it null to use default

	private $New = 'newsposts/new'; //New customers
	private $Save = 'newsposts/save'; //Add New customers
	private $Edit = 'newsposts/update'; //Update customers
...
/* End of file ExtensionNewsPosts.php */
/* Location: ./application/controllers/ExtensionNewsPosts.php */