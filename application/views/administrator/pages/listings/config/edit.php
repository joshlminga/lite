					    ...
					    <div class="col-md-4 col-sm-12">
					        <div class="form-group">
					            <div class="fg-line">
                                    ...
                                    <select class="selectpicker" name="listing_filters[]" multiple>
					            ...
					            <span class="error"><?= form_error('listing_filters') ?></span>
					        </div>
					    </div>
							    ...
							    <div class="col-md-4 col-sm-12 required" id="required">
							        <div class="form-group">
							            <div class="fg-line">
							                ...
							                <input type="text" class="form-control" name="listing_required[]" id="" autocomplete="off" 
							    ...
							    <div class="col-md-4 col-sm-12 optional" id="optional">
							        <div class="form-group">
							            <div class="fg-line">
							                ...
							                <input type="text" class="form-control" name="listing_optional[]" id="" autocomplete="off" 
							                value="<?= stripcslashes($value); ?>">
							            </div>
