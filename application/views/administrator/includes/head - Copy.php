        ...
        <section id="main">
            ...
            <aside id="s-main-menu" class="sidebar">
                ...
                <ul class="main-menu">
                    ...
                    <li class="sub-menu"> <!-- active -->
                        <a href="#" data-ma-action="submenu-toggle">
                            <i class="zmdi zmdi-flash-auto zmdi-hc-fw green_less"></i> News Post 
                        </a>
                        <ul>
                            <li class=""><a href="<?= site_url('newsposts/new'); ?>">New</a></li>
                            <li class=""><a href="#">Stats</a></li>
                            <li class=""><a href="#">Category</a></li>
                            <li class=""><a href="<?= site_url('newsposts'); ?>">Manage</a></li> <!--active -->
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu"> <!-- active -->
                        <a href="#" data-ma-action="submenu-toggle">
                            <i class="zmdi zmdi-flash-auto zmdi-hc-fw green_less"></i> Tracking 
                        </a>
                        <ul>
                            <li class=""><a href="<?= site_url('tracking/track'); ?>">On Order Vehicles</a></li>
                            <li class=""><a href="<?= site_url('tracking'); ?>">Manage</a></li> <!--active -->
                        </ul>
                    </li>
