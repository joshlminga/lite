                ...
                <div class="lb-body">
                	...
                	<?= form_open($form_new,' autocomplete="off" id="" '); ?>
	                    <div class="form-group fg-float">
	                        <div class="fg-line">
	                            <input type="text" class="input-sm form-control fg-input" autocomplete="off" name="user_logname" 
	                            value="<?= set_value('user_logname'); ?>">
                        ...
                        <div class="form-group fg-float">
                            <div class="checkbox m-b-15">
                                <label>
                                    ...
                                    <span class="palette-Purple text">Keep me logged in</span>
                                </label>
                            </div>
                        </div>
