                                            ...
                                            <tr>
                                                <?php for ($k = 0; $k < count($ths); $k++) :  $key = $ths[$k]; ?>
                                                    ...
                                                    <?php if ($key == 'status' || $key == $active_column) : ?>
                                                        ...
                                                        <?php endif ?>
                                                    <?php elseif ($key == 'name') : ?>
                                                        <?php $data_values = json_decode($dataList[$i]->$key, True); ?>
                                                        <td><?= $field_data['name']; ?></td>
                                                    <?php elseif ($key == 'email') : ?>
                                                        <td><?= $field_data['email']; ?></td>
                                                    <?php elseif ($key == 'gender') : ?>
                                                        <?php $gender = $this->CoreCrud->selectSingleValue('inheritances', 'title', array('id' => $field_data['gender'])); ?>
                                                        <td><?= $gender; ?></td>
                                                    <?php else : ?>
