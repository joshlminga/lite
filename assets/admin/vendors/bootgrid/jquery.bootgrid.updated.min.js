! function(t, e) {
    ...
    function u() {
        function i(t) {
            for (var e, i = new RegExp(o.searchPhrase, o.options.caseSensitive ? "g" : "gi"), s = 0; s < o.columns.length; s++)
                if (e = o.columns[s], e.searchable && e.visible && e.converter.to(t[e.id]).search(i) > -1) return !0;
            return !1
        }
    ...
    if (M.defaults = {
            ...
            templates: {
                ...
                select: '<div class="checkbox"><label><input name="select-inputs" type="{{ctx.type}}" class="{{css.selectBox}}" value="{{ctx.value}}" {{ctx.checked}} /><i class="input-helper"></i></label></div>'
            }
